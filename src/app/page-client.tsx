...
const FEATURES = [
	{
		...
		title: "Structure",
		description:
			"Complete file tree with language breakdown and folder organization.",
	},
	{
		num: "02",
		title: "Dependencies",
		description:
			"Visualize import relationships between files to understand connections.",
	},
	{
		num: "03",
		title: "Hotspots",
	...
	},
	{
		...
		title: "Insights",
		description:
			"AI-powered summaries about your codebase structure and health.",
	},
];
					...
					<div className="grid gap-12 lg:grid-cols-[1fr_400px] lg:items-end">
						<div>
							...
							<p className="mt-6 max-w-lg font-sans text-lg text-muted-foreground leading-relaxed">
								Deep structural analysis of any GitHub repository. Understand
								architecture, dependencies, and complexity at a glance.
							</p>
						</div>
